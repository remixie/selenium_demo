...
PATH = "/Users/rem/Documents/chromedriver"
...
arrow_array = [Keys.ARROW_LEFT, Keys.ARROW_UP, Keys.ARROW_RIGHT, Keys.ARROW_DOWN]

while int(time) > 0:
    current_arrow = (re.search("[0-3].*?",driver.find_elements_by_tag_name('img')[-1].get_attribute("src")))[0]
